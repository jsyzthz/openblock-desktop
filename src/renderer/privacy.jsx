...
const PrivacyElement = () => (
    <div className={styles.privacyBox}>
        ...
        <i>The Stemstar Privacy Policy was last updated: October 5, 2020</i>
        <p>
            The Stemstar understands how
            ...
            (&ldquo;Information&rdquo;) we collect through our offline editor (the &ldquo;<a
                href="https://code.stemstar.com/"
                target="_blank"
                rel="noopener noreferrer"
            >Stemstar App</a>&rdquo;), how we use, process, and share it, and what we&apos;re doing to keep it safe. It
        ...
        <h2>What Information Does Stemstar Collect About Me?</h2>
        <p>
            For the purpose of this Privacy Policy, &ldquo;Information&rdquo; means any information relating to an
            identified or identifiable individual. The Stemstar App automatically collects and stores locally the
            following Information through its telemetry system: the title of your project in text form, language
            setting, time zone and events related to your use of the Stemstar App (namely when the Stemstar App was
            opened and closed, if a project file has been loaded or saved, or if a new project is created). If you
            choose to turn on the telemetry sharing feature, the Stemstar App will transmit this information to Stemstar.
            Projects created in the Stemstar App are not transmitted to or accessible by Stemstar.
        </p>
        <h2>How Does Stemstar Use My Information?</h2>
        <p>We use this Information for the following purposes:</p>
        <ul>
            <li>
                <b>Analytics and Improving the Stemstar App</b> - We use the Information to analyze use of the Stemstar
                App and to enhance your learning experience on the Stemstar App.
            </li>
            <li>
                ...
                policies. We may do this by analyzing your use of the Stemstar App.
            </li>
        </ul>
        ...
        <p>
            ...
            (if you choose to allow the Stemstar App to send the Stemstar your Information) to create, analyze and
            share your aggregated or de-identified Information for research purposes, to analyze and enhance your
            learning experience on the Stemstar App and otherwise ensure and improve the safety, security, and
            performance of the Stemstar App. We only rely on our or a third party’s legitimate interests to process your
            Information when these interests are not overridden by your rights and interests.
        </p>
        <h2>How Does Stemstar Share My Information?</h2>
        <p>
            We disclose information that we collect through the Stemstar App to third parties in the following
            circumstances:
        </p>
        <ul>
            <li>
        ...
        <p>
            The Stemstar is a nonprofit organization. As such, the Children&apos;s Online Privacy
            Protection Act (COPPA) does not apply to Stemstar. Nevertheless, Stemstar takes children&apos;s privacy
            seriously. Stemstar collects only minimal information from its users, and only uses and discloses
            information to provide the services and for limited other purposes, such as research, as described in this
            Privacy Policy.
        </p>
        <p>
            Stemstar does not collect information from a student&apos;s education record, as defined by the Family
            Educational Rights and Privacy Act (FERPA). Stemstar does not disclose information of students to any third
        ...
        <ul>
            ...
            <li>
                ...
                provided in a contract between Stemstar and you, or (iii) if we have a compelling reason to do so (such
            ...
            <li>
                ...
                our servers, please contact <a
                    href="mailto:help@stemstar.com"
                    target="_blank"
                    rel="noopener noreferrer"
                >help@stemstar.com</a> for assistance.
            </li>
            <li>
        ...
        <h2>How Does Stemstar Protect My Information?</h2>
        <p>
            Stemstar has in place administrative, physical, and technical procedures that are intended to protect the
            Information we collect on the Stemstar App against accidental or unlawful destruction, accidental loss,
        ...
        <p>
            ...
            the China. (where our Stemstar servers are located) or any other country in which we or our service
        ...
        <p>
            ...
            revised. Your continued use of the Stemstar App following these changes means that you accept the revised
            Privacy Policy.
        </p>
        <h2>Contact Us</h2>
        <p>
            The Stemstar is the entity responsible for the processing of your Information. If you have any
            questions about this Privacy Policy, or if you would like to exercise your rights to your Information, you
            may contact us at <a
                href="mailto:help@stemstar.com"
                target="_blank"
                rel="noopener noreferrer"
            >help@stemstar.com</a> or via mail at:
        </p>
        <div className="vcard">
            <div className="org">Stemstar</div>
            <div className="fn">ATTN: Privacy Policy</div>
            <div className="adr">
                <div className="street-address">Datang Street</div>
                <span className="locality">Yangpu</span>, <span className="region">Shanghai</span> <span
